    ...
    <el-container>
        ...
        <el-main>
            ...
            <el-table class="mt" :data="page.data" style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="pressId" label="出版社号"></el-table-column>
        ...
        <el-dialog title="新增数据" v-model="addDialogVisible" @close="clean">
            <el-form ref="addData" :model="addForm" label-width="80px">
                <el-form-item label="出版社号" prop="pressId">
                    <el-input v-model="addForm.pressId" placeholder="请输入出版社号"></el-input>
                </el-form-item>
        ...
        <el-dialog title="修改数据" v-model="updateDialogVisible" @close="updateFormClean">
            <el-form ref="updateData" :model="updateForm" label-width="80px">
                <el-form-item label="出版社号" prop="pressId">
                    <el-input v-model="updateForm.pressId" placeholder="请输入出版社号"></el-input>
                </el-form-item>
                <el-form-item label="名称" prop="name">
...
const breadcrumbs = ref([
    ...
    { id: "press", title: "出版社管理", url: "/#/sys/press" },
]);
...
const handleAdd = async () => {
    ...
    const res = (await axios.post('/press', addForm.value)).data;
    if (res.code == 200) {
        // 关闭对话框并重置表单
...
const handleDelete = async () => {
    ...
    const res = (await axios.delete('/press', {
        data: ids
    })).data;
    console.log(res)
    if (res.code == 200) {
...
const handleEdit = async () => {
    console.log(updateForm.value)
    const res = (await axios.put('/press', JSON.stringify(updateForm.value), {
        headers: {
...
const loadData = async () => {
    const res = (await axios.post('/press/page', page.value)).data;
    console.log(res);
    if (res.code == 200) {
